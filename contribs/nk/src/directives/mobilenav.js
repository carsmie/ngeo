goog.provide('nk.mobileNavDirective');

goog.require('nk');


/**
 * An "nk-nav" directive defining the behavior of a tree-structured menu.
 *
 ...
 * @ngInject
 */
nk.mobileNavDirective = function() {
  return {
    restrict: 'A',
    link:
        /**
...
nkModule.directive('nkMobileNav', nk.mobileNavDirective);
