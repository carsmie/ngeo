goog.provide('nk.MapController');
goog.provide('nk.mapDirective');
 ...
 *
 * @example
 * <nk-map nk-map-map="mainCtrl.map"></nk-map>
 *
 ...
 * @ngname nkMap
 */
nk.mapDirective = function() {
  return {
    scope: {
      'getMapFn': '&nkMapMap'
    },
    controller: 'nkMapController',
    controllerAs: 'ctrl',
    template: '<div ngeo-map="ctrl.map"></div>'
  };
};

nkModule.directive('nkMap', nk.mapDirective);
 ...
 * @ngInject
 * @ngdoc controller
 * @ngname nkMapController
 */
nk.MapController = function($scope, ngeoLocation, ngeoDebounce) {
...
nkModule.controller('nkMapController', nk.MapController);
